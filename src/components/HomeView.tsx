        ...
        <section className="py-14 sm:py-20 px-4 sm:px-6 mac-bg">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <UseCaseCard icon={Music} title={t.useCases.producerTitle} description={t.useCases.producer} gradient="from-amber-500 to-orange-500" iconGradient="from-amber-400 to-orange-400" delay={0.05} backgroundImage={producerMusicBg} backgroundImageWebp={producerMusicBgWebp} />
              <UseCaseCard icon={Code} title={t.useCases.developerTitle} description={t.useCases.developer} gradient="from-emerald-500 to-teal-500" iconGradient="from-emerald-400 to-teal-400" delay={0.1} backgroundImage={developerCoderBg} backgroundImageWebp={developerCoderBgWebp} />
              <UseCaseCard icon={Wifi} title={t.useCases.remoteTitle} description={t.useCases.remote} gradient="from-blue-500 to-cyan-500" iconGradient="from-blue-400 to-cyan-400" delay={0.15} backgroundImage={remoteWorkerBg} backgroundImageWebp={remoteWorkerBgWebp} />
            </div>
          </div>
        </section>
